"""Contains definition for BooleanVariable."""
...
class BooleanVariable(wfapi.IBooleanVariable):
    ...
    def value(self, new_value: acvi.BooleanValue):
        request = var_val_msg.SetBooleanValueRequest(target=self._id, new_value=bool(new_value))
        self._stub.BooleanVariableSetValue(request)
