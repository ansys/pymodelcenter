...
@pytest.mark.parametrize('element', [
    pytest.param(IDoubleVariable(MockDoubleVariable('Workflow.Assembly.doubleVar', 0)),
                 id="double"),
    pytest.param(IIntegerArray(MockIntegerArray('Workflow.Assembly.intArray', 0)),
                 id="integer array"),
...
@pytest.mark.parametrize('sut,expected_name', [
    pytest.param(IDoubleVariable(MockDoubleVariable("Workflow.Assembly.doubleVar", 0)),
                 "doubleVar", id="double"),
    pytest.param(IIntegerArray(MockIntegerArray("Workflow.Assembly.intArray", 0)),
                 "intArray", id="integer array"),
    pytest.param(Assembly(MockAssembly("Workflow.TopAssembly")),
                 "TopAssembly", id="assembly"),
    pytest.param(IComponent(MockComponent("Workflow.TopAssembly.Optimizer")),
                 "Optimizer", id="component"),
])
